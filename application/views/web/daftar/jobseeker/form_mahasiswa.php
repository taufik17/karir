		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="single-feature">
					...
					<form method="POST" action="<?php echo base_url();?>Register/sregmahasiswa">

						<div class="form-group-daftar">
							<label for="exampleFormControlSelect1">Status<span class="required">*</span>&nbsp:</label>
							<select class="form-control" id="exampleFormControlSelect1" name="status">
								<option selected="selected">Pilih</option>
								<option value="Mahasiswa ITERA">Mahasiswa ITERA</option>
								<option value="Mahasiswa Non ITERA">Mahasiswa Non ITERA</option>
							</select>
						</div>
						...
						<div class="form-group-daftar">
							...
							<input type="text" class="form-control" id="NIM_jobseeker" name="NIM_jobseeker" required>
						</div>
